...
export const sendVerifyRegisterEmail = (
  ...
  return sendVerifyEmail(
    ...
    template
      ...
      .replace('{{link}}', `${envConfig.verifyEmailURL}/email-verifications?token=${email_verify_token}`)
  )
}
...
export const sendForgotPasswordEmail = (
  ...
  return sendVerifyEmail(
    ...
    template
      ...
      .replace('{{link}}', `${envConfig.forgotPasswordURL}/forgot-password?token=${forgot_password_token}`)
  )
}
